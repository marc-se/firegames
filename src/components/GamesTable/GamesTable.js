...
class GamesTable extends Component {
  ...
  playingStateChange = (e, key) => {
    let updateFile = firebase
      .database()
      .ref(`games/${this.props.selectedSystem}/${key}`);
    updateFile.update({
    ...
    const columns = [
      ...
      },
      {
        ...
        render: e => (
          <Tag
            color={
              e === "PAL" ? "#FF9F1C" : e === "JAP" ? "#2EC4B6" : "#E71D36"
            }
          >
            {e}
          </Tag>
      ...
      },
      {
        ...
        render: (e, row) => (
          <Checkbox
            checked={e}
            onChange={e => this.playingStateChange(e, row.key)}
          />
        )
      },
      {
        ...
        render: (e, row) => (
          <Checkbox
            checked={e}
            onChange={e => this.finishedStateChange(e, row.key)}
          />
        )
      },
      {
